...
impl VulkanGodBuilder {
    ...
    fn build(mut self) -> VulkanGod {
        ...
        VulkanGod{
            ...
            // physical_device,
            debug_utils_loader: self.debug_utils_loader.unwrap(),
            debug_call_back: self.debug_call_back.unwrap()
        }
    }
...
pub fn main() {    
    let _vg = VulkanGodBuilder::new(800, 600).build();
}
